...
namespace my_nav2_planner {
    ...
    nav_msgs::msg::Path MyAStarPlanner::createPlan(
        ...
        if (!start_in_map || !goal_in_map) {
            ...
            if (!start_in_map) {
                throw nav2_core::StartOutsideMapBounds("Start is outside of costmap bounds");
            }
            throw nav2_core::GoalOutsideMapBounds("Goal is outside of costmap bounds");
        }
        ...
        try {
            search = searchCells(
                *costmap_, mx_start, my_start, mx_goal, my_goal, cancel_checker);
    ...
    MyAStarPlanner::AStarSearchResult MyAStarPlanner::searchCells(
        ...
        if (start_idx != goal_idx &&
            ...
            throw nav2_core::GoalOccupied("Goal cell is inside a lethal/inscribed obstacle");
        }
